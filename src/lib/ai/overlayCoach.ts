...
export function buildOverlayReviewContext(tracks: OverlayTrack[]): Record<string, unknown> {
  return {
    ...
    rules: [
      ...
      "Flavors are roast-curve goals, not a promise the lot will taste like that word. They cannot invent blueberry, jasmine, or bergamot. lightSweet = honey/cane; caramel = toffee sauce; deepSweet = panela/molasses/cooked fruit (not candy or milk chocolate); cocoa = nutty/chocolate and needs medium colour.",
