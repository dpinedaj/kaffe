...
const en = {
  ...
  "tech.chemex.hoffmann.blurb":
    "Hoffmann Chemex as a V60. Thick bonded paper, slower and cleaner than a cone.",
  ...
  "tech.switch.jaafar.flavor": "Clarity / floral",
  "tech.switch.jaafar.mechanic": "Open 100 g spiral · close at 1:00 for the last 100 g · open at 2:00",
  "tech.switch.jaafar.blurb": "Nas Jaafar, World Brewers Cup 2026 champion (Malaysia). Round-one routine: 15 g / 200 g at 92 °C, ~2:10, on a UFO cone over a Switch base. Percolate for clarity, immerse the second half for sweetness. No bloom — wait until the lot is degassed.",
  "tech.aeropress.little.flavor": "Sweet / clean",
  "tech.aeropress.little.mechanic": "Inverted 94 g at 92 °C, 35 stirs, press 1:40–2:10, 150 g bypass at 90 °C",
  "tech.aeropress.little.blurb": "Jibbi Little, WAC 2022 champion (Australia). 18 g, coarse and sifted, 94 g at 92 °C stirred 35 times, flip at 1:30, press to 2:10, then 150 g at 90 °C. Aims for ~1.30–1.35% TDS in the cup.",
  "tech.v60.winton.flavor": "Clarity / sweetness",
  "tech.v60.winton.mechanic": "60 g bloom at 93 °C, then four 60 g pours at 88 °C. No stir; swirl at the end.",
  "tech.v60.winton.blurb": "Matt Winton, World Brewers Cup 2021 champion (Switzerland). 20 g / 300 g. Each pour starts when the bed is almost drained; the cooler water after the bloom keeps it sweet and clear.",
  "tech.v60.hoffmann1.flavor": "Even / one cup",
  "tech.v60.hoffmann1.mechanic": "50 g bloom + swirl, then four 50 g pours by 2:00, swirl, ~3:00",
  "tech.v60.hoffmann1.blurb": "James Hoffmann’s “A Better 1-Cup V60” (2023). 15 g / 250 g, freshly boiled water for lighter roasts, medium-fine. Small pulses keep a 15 g bed even.",
  "tech.kalita.april.flavor": "Clarity / sweet",
  "tech.kalita.april.mechanic": "Two 100 g pours: circles for 30 g, then the centre for 70 g",
  "tech.kalita.april.blurb": "Patrik Rolf (April, WBrC 2019 runner-up). 13 g / 200 g at 94 °C, medium-fine, ~2:30–3:00. Written for the flat April brewer; runs on any flat bottom.",
  "tech.kalita.wendelboe.flavor": "Clean / sweet",
  "tech.kalita.wendelboe.mechanic": "~60 g stirred bloom, to 200 g by 0:30, circles to the end by ~2:15, stir the brew",
  "tech.kalita.wendelboe.blurb": "Tim Wendelboe (Oslo). 65 g/L, medium-fine, ~3:00–3:30 total. Over 3:30 → coarser; well under 2:00 → finer.",
  "tech.frenchpress.wendelboe.flavor": "Clean / sweet",
  "tech.frenchpress.wendelboe.mechanic": "Half the water, stir, top up, 4–5 min, stir and skim, press slowly, wait",
  "tech.frenchpress.wendelboe.blurb": "Tim Wendelboe. 65–70 g/L with boiling water, filter grind or a touch finer. Skim the foam and let it settle 1–5 min before a gentle pour.",
  "tech.coldbrew.kyoto.flavor": "Sweet / clear cold",
  "tech.coldbrew.kyoto.mechanic": "Ice water drips through the bed, ~1 drop / 2 s, 5 h+",
  "tech.coldbrew.kyoto.blurb": "Slow-drip (“Dutch”) tower, e.g. Hario Water Dripper. 60 g to ~500 g of ice + water, coarse, then dilute to taste. Clearer than a steep; suits light, fruity lots.",
  "tech.espresso.allonge.flavor": "Acid / fruit / high extraction",
  "tech.espresso.allonge.mechanic": "No pre-infusion, 8–9 bar, 4–4.5 ml/s, 1:4–1:6 in 30–60 s",
  "tech.espresso.allonge.blurb": "Scott Rao’s allongé (Decent documentation). 18 g → ~90 g at ~92 °C, ground coarser than espresso. For light to ultra-light roasts; aims at ~22–23% extraction.",
  "tech.chemex.stumptown.flavor": "Clean / full",
  "tech.chemex.stumptown.mechanic": "150 g bloom, wiggle to 450 g, top to 700 g, ~4:00",
  "tech.chemex.stumptown.blurb": "Stumptown brew guide. 42 g / 700 g just off boil (~96 °C), kosher-salt grind. Bigger batch, fuller cup than the V60-style Chemex.",
  "tech.siphon.sprudge.flavor": "Balanced / clean",
  "tech.siphon.sprudge.mechanic": "Water up, grounds in, stir 0:00 and 0:30, heat off at 2:00, draw down",
  "tech.siphon.sprudge.blurb": "Sprudge siphon guide. 35 g / 560 g (1:16), ~93 °C held once risen, beach-sand grind, ~3:30 total.",
  "tech.siphon.bluebottle.flavor": "Bright / aromatic",
  "tech.siphon.bluebottle.mechanic": "Grounds in at 0:40, 70 s steep, heat off, 10 brisk stirs, ~60 s draw",
  "tech.siphon.bluebottle.blurb": "Blue Bottle’s café siphon (via Gota). 24 g / 300 g at 90 °C, medium, ~3:10. Shorter, cooler contact than Sprudge — more aromatic, lighter body.",
  "tech.batch.sca.flavor": "Reference / balanced",
  "tech.batch.sca.mechanic": "55 g/L, 92–96 °C at the grounds, 4–8 min contact, 2.5–5 cm bed",
  "tech.batch.sca.blurb": "SCA Golden Cup and certified-brewer standard. Aim for 1.15–1.35% TDS and 18–22% extraction. Stir the carafe before pouring; hold at 80–85 °C, not on a hot plate for hours.",
  "tech.batch.rao.flavor": "Sweet / even",
  "tech.batch.rao.mechanic": "1:16–1:18, 3–5 cm bed, 6:00–6:30 contact, no bypass under ~4 L",
  "tech.batch.rao.blurb": "Scott Rao, Batch Brew Basics. Coarse (the coarsest ~15% of the dial), deep enough bed, a program that finishes spraying by ~4:30. Keep batches under 2 L for evenness.",
  "tech.batch.wendelboe.flavor": "Clean / stronger",
  "tech.batch.wendelboe.mechanic": "65 g/L in a rinsed filter, stir when dripping starts, stir the carafe",
  "tech.batch.wendelboe.blurb": "Tim Wendelboe’s home filter-machine method. 32.5 g / 500 g, ~3:00–3:30. A stronger cup than the SCA box — Nordic style.",
  "step.switch.jaafar.prep.title": "Valve open",
  "step.switch.jaafar.prep.detail": "Rinse the paper, valve open. Flat, level bed.",
  "step.switch.jaafar.open.title": "Open spiral",
  "step.switch.jaafar.open.detail": "{half} g at {temp} in circles. Let it drip ~58 s.",
  "step.switch.jaafar.close.title": "Close + pour",
  "step.switch.jaafar.close.detail": "Close the valve, pour to {w} g. Immersion from here.",
  "step.switch.jaafar.drain.title": "Open + drain",
  "step.switch.jaafar.drain.detail": "Open ~10 s to drain. Done ~{t}.{stall}",
  "step.v60.winton.prep.title": "Two temps",
  "step.v60.winton.prep.detail": "Rinse. Bloom water at 93 °C, the rest cooled to 88 °C.",
  "step.v60.winton.bloom.title": "Bloom",
  "step.v60.winton.bloom.detail": "{pour} g at {temp}, centre-out. No stir, no swirl. ~30 s.",
  "step.v60.winton.pours.title": "Four pours",
  "step.v60.winton.pours.detail": "{pour} g each at {cool} °C to {w} g. Start each when the bed is almost drained; pour a little high.",
  "step.v60.winton.swirl.title": "Swirl",
  "step.v60.winton.swirl.detail": "One swirl, drain. ~{t}.{stall}",
  "step.v60.hoffmann1.prep.title": "Boil",
  "step.v60.hoffmann1.prep.detail": "Rinse. Freshly boiled water for light roasts.",
  "step.v60.hoffmann1.bloom.title": "Bloom",
  "step.v60.hoffmann1.bloom.detail": "{pulse} g at {temp}, gentle swirl at 0:10.",
  "step.v60.hoffmann1.pulses.title": "Pulses",
  "step.v60.hoffmann1.pulses.detail": "To {a} g at 0:45, {b} g at 1:10, {c} g at 1:30, {w} g at 1:50.",
  "step.v60.hoffmann1.swirl.title": "Swirl",
  "step.v60.hoffmann1.swirl.detail": "Gentle swirl, flat bed. Done ~{t}.{stall}",
  "step.aero.little.prep.title": "Inverted",
  "step.aero.little.prep.detail": "Inverted, one rinsed paper. Coarse grind, fines sifted if you can.",
  "step.aero.little.pour.title": "Pour + stir",
  "step.aero.little.pour.detail": "{w} g at {temp}, stir gently 35 times.",
  "step.aero.little.flip.title": "Cap + flip",
  "step.aero.little.flip.detail": "Cap, push the air out, flip at 1:30.",
  "step.aero.little.press.title": "Press",
  "step.aero.little.press.detail": "Press slowly to {t}.",
  "step.aero.little.bypass.title": "Bypass",
  "step.aero.little.bypass.detail": "Add {bypass} g at {hot} °C.",
  "step.kalita.april.prep.title": "Flat bed",
  "step.kalita.april.prep.detail": "Rinse. Level the bed. Two pours only.",
  "step.kalita.april.p1.title": "Pour 1",
  "step.kalita.april.p1.detail": "{ring} g in circles, then the centre to {half} g at {temp}.",
  "step.kalita.april.p2.title": "Pour 2",
  "step.kalita.april.p2.detail": "Same again: {ring} g in circles, centre to {w} g.",
  "step.kalita.april.draw.title": "Drawdown",
  "step.kalita.april.draw.detail": "Done ~{t}.{stall}",
  "step.kalita.wendelboe.prep.title": "Rinse",
  "step.kalita.wendelboe.prep.detail": "Rinse the paper, pre-heat the server.",
  "step.kalita.wendelboe.bloom.title": "Bloom + stir",
  "step.kalita.wendelboe.bloom.detail": "{first} g at {temp}, stir so every ground is wet.",
  "step.kalita.wendelboe.mid.title": "Circles",
  "step.kalita.wendelboe.mid.detail": "To {mid} g by 0:30, then slow circles to {w} g, done pouring by ~2:15.",
  "step.kalita.wendelboe.draw.title": "Drain + stir",
  "step.kalita.wendelboe.draw.detail": "~1 min drip-through, done ~{t}. Stir the brew before serving.{stall}",
  "step.french.wendelboe.prep.title": "Boil",
  "step.french.wendelboe.prep.detail": "Boiling water, filter grind or a touch finer.",
  "step.french.wendelboe.half.title": "Half + stir",
  "step.french.wendelboe.half.detail": "{half} g at {temp}, stir briefly.",
  "step.french.wendelboe.top.title": "Top up",
  "step.french.wendelboe.top.detail": "To {w} g. Lid on, steep 4–5 min.",
  "step.french.wendelboe.skim.title": "Stir + skim",
  "step.french.wendelboe.skim.detail": "Stir 3–5 times, skim the foam.",
  "step.french.wendelboe.press.title": "Press + wait",
  "step.french.wendelboe.press.detail": "Press slowly, wait 1–5 min, pour gently.",
  "step.cold.kyoto.prep.title": "Wet the bed",
  "step.cold.kyoto.prep.detail": "{coffee} g coarse in the chamber. Wet and stir, then a paper disc on top.",
  "step.cold.kyoto.load.title": "Load the tower",
  "step.cold.kyoto.load.detail": "{w} g in the top: ~{ice} g ice, the rest water.",
  "step.cold.kyoto.drip.title": "Drip",
  "step.cold.kyoto.drip.detail": "~1 drop every 2 s. About {h} h.",
  "step.cold.kyoto.serve.title": "Dilute",
  "step.cold.kyoto.serve.detail": "It is a concentrate — dilute to taste, fridge up to a few days.",
  "step.espresso.allonge.setup": "{prep} Grind coarser than espresso. No pre-infusion.",
  "step.espresso.allonge.flow.title": "Full flow",
  "step.espresso.allonge.flow.detail": "8–9 bar, ~4–4.5 ml/s from the start.",
  "step.espresso.allonge.stop.title": "Stop",
  "step.espresso.allonge.stop.detail": "Cut at {yieldG} g, ~{time} s. Long ratio, light body, high clarity.",
  "step.chemex.stumptown.prep.title": "Rinse well",
  "step.chemex.stumptown.prep.detail": "Rinse the thick paper, dump the water. Three-layer side on the spout.",
  "step.chemex.stumptown.bloom.title": "Bloom",
  "step.chemex.stumptown.bloom.detail": "{bloom} g at {temp}, stir.",
  "step.chemex.stumptown.mid.title": "Wiggle pour",
  "step.chemex.stumptown.mid.detail": "Wiggle to {mid} g.",
  "step.chemex.stumptown.top.title": "Top up",
  "step.chemex.stumptown.top.detail": "To {w} g. Done ~{t}; lift the filter out.",
  "step.siphon.prep.title": "Heat",
  "step.siphon.prep.detail": "{w} g in the lower bowl, filter hooked in the top. Heat until it rises.",
  "step.siphon.sprudge.add.title": "Grounds in",
  "step.siphon.sprudge.add.detail": "Lower the heat to hold ~{temp}. Add {coffee} g, stir gently.",
  "step.siphon.sprudge.stir.title": "Stir",
  "step.siphon.sprudge.stir.detail": "Stir again gently.",
  "step.siphon.sprudge.off.title": "Heat off",
  "step.siphon.sprudge.off.detail": "Heat off. A gentle stir as it starts to fall.",
  "step.siphon.bb.rise.title": "Rise",
  "step.siphon.bb.rise.detail": "Let the water rise and settle near {temp}.",
  "step.siphon.bb.add.title": "Grounds in",
  "step.siphon.bb.add.detail": "Add {coffee} g, stir to wet. Steep ~70 s.",
  "step.siphon.bb.off.title": "Heat off + stir",
  "step.siphon.bb.off.detail": "Heat off, 10 brisk stirs.",
  "step.siphon.draw.title": "Drawdown",
  "step.siphon.draw.detail": "It pulls down through the filter. Done ~{t}. A dome of grounds means an even brew.",
  "step.batch.sca.prep.title": "Load",
  "step.batch.sca.prep.detail": "{coffee} g for {w} g water (~{gPerL} g/L). Rinse the filter; bed 2.5–5 cm deep.",
  "step.batch.sca.start.title": "Brew",
  "step.batch.sca.start.detail": "Start. The brewer should reach 92 °C in the first minute and stay ≤ 96 °C ({temp} target).",
  "step.batch.rao.prep.title": "Load",
  "step.batch.rao.prep.detail": "{coffee} g for {w} g, coarse. Bed 3–5 cm; batch under 2 L.",
  "step.batch.rao.start.title": "Brew",
  "step.batch.rao.start.detail": "Spray done by ~4:30, total contact 6:00–6:30 at {temp}. No bypass at this size.",
  "step.batch.wendelboe.prep.title": "Load",
  "step.batch.wendelboe.prep.detail": "{coffee} g for {w} g in a rinsed filter.",
  "step.batch.wendelboe.start.title": "Stir once",
  "step.batch.wendelboe.start.detail": "Switch on. When dripping starts, give the wet grounds a small stir.",
  "step.batch.stir.title": "Stir the carafe",
  "step.batch.stir.detail": "Done ~{t}. Stir the carafe before pouring — the first and last drips differ in strength.",
} as const;
...
const es: Record<RecipeKey, string> = {
  ...
  "tech.switch.jaafar.flavor": "Claridad / floral",
  "tech.switch.jaafar.mechanic": "Abierto 100 g en espiral · cierra a 1:00 para los últimos 100 g · abre a 2:00",
  "tech.switch.jaafar.blurb": "Nas Jaafar, campeón del World Brewers Cup 2026 (Malasia). Rutina de la primera ronda: 15 g / 200 g a 92 °C, ~2:10, en un cono UFO sobre base Switch. Percola para claridad, inmersión en la segunda mitad para dulzor. Sin bloom — espera a que el lote desgasifique.",
  "tech.aeropress.little.flavor": "Dulce / limpio",
  "tech.aeropress.little.mechanic": "Invertido 94 g a 92 °C, 35 remociones, presiona 1:40–2:10, bypass 150 g a 90 °C",
  "tech.aeropress.little.blurb": "Jibbi Little, campeona del WAC 2022 (Australia). 18 g, grueso y tamizado, 94 g a 92 °C removido 35 veces, voltea a 1:30, presiona hasta 2:10 y luego 150 g a 90 °C. Busca ~1,30–1,35% TDS en la taza.",
  "tech.v60.winton.flavor": "Claridad / dulzor",
  "tech.v60.winton.mechanic": "Bloom 60 g a 93 °C, luego cuatro vertidos de 60 g a 88 °C. Sin remover; swirl al final.",
  "tech.v60.winton.blurb": "Matt Winton, campeón del World Brewers Cup 2021 (Suiza). 20 g / 300 g. Cada vertido empieza cuando la cama casi drenó; el agua más fresca tras el bloom lo mantiene dulce y claro.",
  "tech.v60.hoffmann1.flavor": "Parejo / una taza",
  "tech.v60.hoffmann1.mechanic": "Bloom 50 g + swirl, luego cuatro vertidos de 50 g hasta 2:00, swirl, ~3:00",
  "tech.v60.hoffmann1.blurb": "“A Better 1-Cup V60” de James Hoffmann (2023). 15 g / 250 g, agua recién hervida para tuestes claros, medio-fino. Pulsos chicos mantienen pareja una cama de 15 g.",
  "tech.kalita.april.flavor": "Claridad / dulce",
  "tech.kalita.april.mechanic": "Dos vertidos de 100 g: círculos para 30 g, luego el centro para 70 g",
  "tech.kalita.april.blurb": "Patrik Rolf (April, subcampeón WBrC 2019). 13 g / 200 g a 94 °C, medio-fino, ~2:30–3:00. Escrita para el April de fondo plano; sirve en cualquier fondo plano.",
  "tech.kalita.wendelboe.flavor": "Limpio / dulce",
  "tech.kalita.wendelboe.mechanic": "Bloom removido de ~60 g, a 200 g hacia 0:30, círculos hasta el final hacia ~2:15, remueve el café",
  "tech.kalita.wendelboe.blurb": "Tim Wendelboe (Oslo). 65 g/L, medio-fino, ~3:00–3:30 en total. Más de 3:30 → más grueso; bastante menos de 2:00 → más fino.",
  "tech.frenchpress.wendelboe.flavor": "Limpio / dulce",
  "tech.frenchpress.wendelboe.mechanic": "Mitad del agua, remueve, completa, 4–5 min, remueve y quita espuma, presiona lento, espera",
  "tech.frenchpress.wendelboe.blurb": "Tim Wendelboe. 65–70 g/L con agua hirviendo, molienda de filtro o un poco más fina. Quita la espuma y deja asentar 1–5 min antes de servir con suavidad.",
  "tech.coldbrew.kyoto.flavor": "Dulce / frío claro",
  "tech.coldbrew.kyoto.mechanic": "Agua con hielo gotea por la cama, ~1 gota / 2 s, 5 h+",
  "tech.coldbrew.kyoto.blurb": "Torre de goteo lento (“Dutch”), p. ej. Hario Water Dripper. 60 g para ~500 g de hielo + agua, grueso, luego diluye a gusto. Más claro que una inmersión; va con lotes claros y frutales.",
  "tech.espresso.allonge.flavor": "Ácido / fruta / alta extracción",
  "tech.espresso.allonge.mechanic": "Sin preinfusión, 8–9 bar, 4–4,5 ml/s, 1:4–1:6 en 30–60 s",
  "tech.espresso.allonge.blurb": "El allongé de Scott Rao (documentación de Decent). 18 g → ~90 g a ~92 °C, molido más grueso que un espresso. Para tuestes claros a ultraclaros; busca ~22–23% de extracción.",
  "tech.chemex.stumptown.flavor": "Limpio / lleno",
  "tech.chemex.stumptown.mechanic": "Bloom 150 g, vertido ondulado a 450 g, completa a 700 g, ~4:00",
  "tech.chemex.stumptown.blurb": "Guía de Stumptown. 42 g / 700 g recién sacada del hervor (~96 °C), molienda tipo sal kosher. Más cantidad y taza más llena que el Chemex estilo V60.",
  "tech.siphon.sprudge.flavor": "Balanceado / limpio",
  "tech.siphon.sprudge.mechanic": "Sube el agua, entra el café, remueve 0:00 y 0:30, apaga a 2:00, drena",
  "tech.siphon.sprudge.blurb": "Guía de sifón de Sprudge. 35 g / 560 g (1:16), ~93 °C sostenidos al subir, molienda tipo arena de playa, ~3:30 en total.",
  "tech.siphon.bluebottle.flavor": "Brillante / aromático",
  "tech.siphon.bluebottle.mechanic": "Café a 0:40, 70 s de inmersión, apaga, 10 remociones rápidas, ~60 s de drenado",
  "tech.siphon.bluebottle.blurb": "El sifón de café de Blue Bottle (vía Gota). 24 g / 300 g a 90 °C, medio, ~3:10. Contacto más corto y fresco que Sprudge — más aromático, menos cuerpo.",
  "tech.batch.sca.flavor": "Referencia / balanceado",
  "tech.batch.sca.mechanic": "55 g/L, 92–96 °C en el café, 4–8 min de contacto, cama de 2,5–5 cm",
  "tech.batch.sca.blurb": "Golden Cup de la SCA y estándar de cafeteras certificadas. Busca 1,15–1,35% TDS y 18–22% de extracción. Remueve la jarra antes de servir; mantén a 80–85 °C, no horas en una placa caliente.",
  "tech.batch.rao.flavor": "Dulce / parejo",
  "tech.batch.rao.mechanic": "1:16–1:18, cama de 3–5 cm, 6:00–6:30 de contacto, sin bypass bajo ~4 L",
  "tech.batch.rao.blurb": "Scott Rao, Batch Brew Basics. Grueso (el ~15% más grueso del dial), cama suficientemente alta, un programa que termina de rociar hacia ~4:30. Tandas de menos de 2 L para que sea parejo.",
  "tech.batch.wendelboe.flavor": "Limpio / más fuerte",
  "tech.batch.wendelboe.mechanic": "65 g/L en filtro enjuagado, remueve al empezar a gotear, remueve la jarra",
  "tech.batch.wendelboe.blurb": "El método de cafetera de filtro de Tim Wendelboe. 32,5 g / 500 g, ~3:00–3:30. Una taza más fuerte que la caja SCA — estilo nórdico.",
  "step.switch.jaafar.prep.title": "Válvula abierta",
  "step.switch.jaafar.prep.detail": "Enjuaga el papel, válvula abierta. Cama plana y nivelada.",
  "step.switch.jaafar.open.title": "Espiral abierta",
  "step.switch.jaafar.open.detail": "{half} g a {temp} en círculos. Deja gotear ~58 s.",
  "step.switch.jaafar.close.title": "Cierra + vierte",
  "step.switch.jaafar.close.detail": "Cierra la válvula, vierte hasta {w} g. Inmersión desde aquí.",
  "step.switch.jaafar.drain.title": "Abre + drena",
  "step.switch.jaafar.drain.detail": "Abre ~10 s para drenar. Listo ~{t}.{stall}",
  "step.v60.winton.prep.title": "Dos temperaturas",
  "step.v60.winton.prep.detail": "Enjuaga. Agua del bloom a 93 °C, el resto enfriada a 88 °C.",
  "step.v60.winton.bloom.title": "Bloom",
  "step.v60.winton.bloom.detail": "{pour} g a {temp}, del centro hacia afuera. Sin remover ni swirl. ~30 s.",
  "step.v60.winton.pours.title": "Cuatro vertidos",
  "step.v60.winton.pours.detail": "{pour} g cada uno a {cool} °C hasta {w} g. Empieza cada uno cuando la cama casi drenó; vierte un poco alto.",
  "step.v60.winton.swirl.title": "Swirl",
  "step.v60.winton.swirl.detail": "Un swirl, drena. ~{t}.{stall}",
  "step.v60.hoffmann1.prep.title": "Hervir",
  "step.v60.hoffmann1.prep.detail": "Enjuaga. Agua recién hervida para tuestes claros.",
  "step.v60.hoffmann1.bloom.title": "Bloom",
  "step.v60.hoffmann1.bloom.detail": "{pulse} g a {temp}, swirl suave a 0:10.",
  "step.v60.hoffmann1.pulses.title": "Pulsos",
  "step.v60.hoffmann1.pulses.detail": "A {a} g en 0:45, {b} g en 1:10, {c} g en 1:30, {w} g en 1:50.",
  "step.v60.hoffmann1.swirl.title": "Swirl",
  "step.v60.hoffmann1.swirl.detail": "Swirl suave, cama plana. Listo ~{t}.{stall}",
  "step.aero.little.prep.title": "Invertido",
  "step.aero.little.prep.detail": "Invertido, un papel enjuagado. Molienda gruesa, tamiza finos si puedes.",
  "step.aero.little.pour.title": "Vierte + remueve",
  "step.aero.little.pour.detail": "{w} g a {temp}, remueve suave 35 veces.",
  "step.aero.little.flip.title": "Tapa + voltea",
  "step.aero.little.flip.detail": "Tapa, saca el aire, voltea a 1:30.",
  "step.aero.little.press.title": "Presiona",
  "step.aero.little.press.detail": "Presiona lento hasta {t}.",
  "step.aero.little.bypass.title": "Bypass",
  "step.aero.little.bypass.detail": "Agrega {bypass} g a {hot} °C.",
  "step.kalita.april.prep.title": "Cama plana",
  "step.kalita.april.prep.detail": "Enjuaga. Nivela la cama. Solo dos vertidos.",
  "step.kalita.april.p1.title": "Vertido 1",
  "step.kalita.april.p1.detail": "{ring} g en círculos, luego el centro hasta {half} g a {temp}.",
  "step.kalita.april.p2.title": "Vertido 2",
  "step.kalita.april.p2.detail": "Igual: {ring} g en círculos, centro hasta {w} g.",
  "step.kalita.april.draw.title": "Drenado",
  "step.kalita.april.draw.detail": "Listo ~{t}.{stall}",
  "step.kalita.wendelboe.prep.title": "Enjuagar",
  "step.kalita.wendelboe.prep.detail": "Enjuaga el papel, precalienta la jarra.",
  "step.kalita.wendelboe.bloom.title": "Bloom + remover",
  "step.kalita.wendelboe.bloom.detail": "{first} g a {temp}, remueve para mojar todo.",
  "step.kalita.wendelboe.mid.title": "Círculos",
  "step.kalita.wendelboe.mid.detail": "A {mid} g hacia 0:30, luego círculos lentos hasta {w} g, terminando de verter hacia ~2:15.",
  "step.kalita.wendelboe.draw.title": "Drena + remueve",
  "step.kalita.wendelboe.draw.detail": "~1 min de goteo, listo ~{t}. Remueve el café antes de servir.{stall}",
  "step.french.wendelboe.prep.title": "Hervir",
  "step.french.wendelboe.prep.detail": "Agua hirviendo, molienda de filtro o un poco más fina.",
  "step.french.wendelboe.half.title": "Mitad + remover",
  "step.french.wendelboe.half.detail": "{half} g a {temp}, remueve un momento.",
  "step.french.wendelboe.top.title": "Completar",
  "step.french.wendelboe.top.detail": "Hasta {w} g. Tapa, 4–5 min de inmersión.",
  "step.french.wendelboe.skim.title": "Remover + espumar",
  "step.french.wendelboe.skim.detail": "Remueve 3–5 veces, quita la espuma.",
  "step.french.wendelboe.press.title": "Presionar + esperar",
  "step.french.wendelboe.press.detail": "Presiona lento, espera 1–5 min, sirve con suavidad.",
  "step.cold.kyoto.prep.title": "Mojar la cama",
  "step.cold.kyoto.prep.detail": "{coffee} g grueso en la cámara. Moja y remueve, luego un disco de papel encima.",
  "step.cold.kyoto.load.title": "Cargar la torre",
  "step.cold.kyoto.load.detail": "{w} g arriba: ~{ice} g de hielo, el resto agua.",
  "step.cold.kyoto.drip.title": "Goteo",
  "step.cold.kyoto.drip.detail": "~1 gota cada 2 s. Unas {h} h.",
  "step.cold.kyoto.serve.title": "Diluir",
  "step.cold.kyoto.serve.detail": "Es un concentrado — diluye a gusto, nevera hasta unos días.",
  "step.espresso.allonge.setup": "{prep} Muele más grueso que espresso. Sin preinfusión.",
  "step.espresso.allonge.flow.title": "Flujo completo",
  "step.espresso.allonge.flow.detail": "8–9 bar, ~4–4,5 ml/s desde el inicio.",
  "step.espresso.allonge.stop.title": "Cortar",
  "step.espresso.allonge.stop.detail": "Corta en {yieldG} g, ~{time} s. Ratio largo, poco cuerpo, mucha claridad.",
  "step.chemex.stumptown.prep.title": "Enjuagar bien",
  "step.chemex.stumptown.prep.detail": "Enjuaga el papel grueso, bota el agua. El lado triple hacia el pico.",
  "step.chemex.stumptown.bloom.title": "Bloom",
  "step.chemex.stumptown.bloom.detail": "{bloom} g a {temp}, remueve.",
  "step.chemex.stumptown.mid.title": "Vertido ondulado",
  "step.chemex.stumptown.mid.detail": "Ondulado hasta {mid} g.",
  "step.chemex.stumptown.top.title": "Completar",
  "step.chemex.stumptown.top.detail": "Hasta {w} g. Listo ~{t}; saca el filtro.",
  "step.siphon.prep.title": "Calentar",
  "step.siphon.prep.detail": "{w} g en la parte baja, filtro enganchado arriba. Calienta hasta que suba.",
  "step.siphon.sprudge.add.title": "Entra el café",
  "step.siphon.sprudge.add.detail": "Baja el fuego para sostener ~{temp}. Agrega {coffee} g, remueve suave.",
  "step.siphon.sprudge.stir.title": "Remover",
  "step.siphon.sprudge.stir.detail": "Remueve de nuevo, suave.",
  "step.siphon.sprudge.off.title": "Apagar",
  "step.siphon.sprudge.off.detail": "Apaga. Un remover suave cuando empieza a bajar.",
  "step.siphon.bb.rise.title": "Subir",
  "step.siphon.bb.rise.detail": "Deja subir el agua y que se asiente cerca de {temp}.",
  "step.siphon.bb.add.title": "Entra el café",
  "step.siphon.bb.add.detail": "Agrega {coffee} g, remueve para mojar. ~70 s de inmersión.",
  "step.siphon.bb.off.title": "Apagar + remover",
  "step.siphon.bb.off.detail": "Apaga, 10 remociones rápidas.",
  "step.siphon.draw.title": "Drenado",
  "step.siphon.draw.detail": "Baja a través del filtro. Listo ~{t}. Un domo de café indica una extracción pareja.",
  "step.batch.sca.prep.title": "Cargar",
  "step.batch.sca.prep.detail": "{coffee} g para {w} g de agua (~{gPerL} g/L). Enjuaga el filtro; cama de 2,5–5 cm.",
  "step.batch.sca.start.title": "Preparar",
  "step.batch.sca.start.detail": "Inicia. La cafetera debe llegar a 92 °C en el primer minuto y no pasar de 96 °C (objetivo {temp}).",
  "step.batch.rao.prep.title": "Cargar",
  "step.batch.rao.prep.detail": "{coffee} g para {w} g, grueso. Cama de 3–5 cm; tanda de menos de 2 L.",
  "step.batch.rao.start.title": "Preparar",
  "step.batch.rao.start.detail": "Rociado listo hacia ~4:30, contacto total 6:00–6:30 a {temp}. Sin bypass a este tamaño.",
  "step.batch.wendelboe.prep.title": "Cargar",
  "step.batch.wendelboe.prep.detail": "{coffee} g para {w} g en un filtro enjuagado.",
  "step.batch.wendelboe.start.title": "Remover una vez",
  "step.batch.wendelboe.start.detail": "Enciende. Cuando empiece a gotear, remueve un poco el café mojado.",
  "step.batch.stir.title": "Remover la jarra",
  "step.batch.stir.detail": "Listo ~{t}. Remueve la jarra antes de servir — las primeras y últimas gotas tienen distinta fuerza.",
};
