...
const en = {
  ...
  "step.switch.fukahori.bloom.detail": "{bloom} g at {temp} (she uses 50 g on 14 g). Swirl. 30 s.",
  ...
  "step.switch.hybrid.bloom.detail": "{bloom} g at {temp}. 40 s. Wet everything.",
  "step.switch.hybrid.mid.title": "Open pours",
  "step.switch.hybrid.mid.detail": "Open the valve. Pour to {a} g, then at 1:30 to {b} g.",
  ...
  "step.switch.hold.bloom.detail": "{bloom} g at {temp}. 40 s.",
  ...
  "step.v60.hedrick.b1.detail": "{first} g at {temp}, ~7 g/s. Do not swirl. 30 s.",
...
const es: Record<RecipeKey, string> = {
  ...
  "step.switch.fukahori.bloom.detail": "{bloom} g a {temp} (ella usa 50 g sobre 14 g). Swirl. 30 s.",
  ...
  "step.switch.hybrid.bloom.detail": "{bloom} g a {temp}. 40 s. Moja todo.",
  "step.switch.hybrid.mid.title": "Vertidos abiertos",
  "step.switch.hybrid.mid.detail": "Abre la válvula. Vierte hasta {a} g, luego a 1:30 hasta {b} g.",
  ...
  "step.switch.hold.bloom.detail": "{bloom} g a {temp}. 40 s.",
  ...
  "step.v60.hedrick.b1.title": "Bloom 1",
  "step.v60.hedrick.b1.detail": "{first} g a {temp}, ~7 g/s. No hagas swirl. 30 s.",
  "step.v60.hedrick.b2.title": "Bloom 2",
